...
Race DES_WildElfRace = Game.GetFormFromFile(0x820, "AyleidRace.esp") As Race
Race DES_DeepElfRace = Game.GetFormFromFile(0x949, "DwarfRace.esp") As Race
Race DES_SeaElfRace = Game.GetFormFromFile(0x94D, "SeaElfRace.esp") As Race
Race DES_SnowElfRace = Game.GetFormFromFile(0x377D, "Dawnguard.esm") As Race
Race DES_AkaviriRace = Game.GetFormFromFile(0x851, "TsaesciRace.esp") As Race
